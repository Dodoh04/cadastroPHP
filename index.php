		...
		<div class="col s12 m6 push-m3">
			...
			<tbody>
				<?php 
					...
					$sql = "SELECT * FROM tabeladeclientes";
					...
					?>				
						...
						<tr>
							...
							<td><?php echo $dados['idadeCliente']; ?></td>

							<td><a href="alterar.php?id=<?php echo $dados['idCliente']; ?>" class="btn-floating orange"><i class="material-icons">edit</i></a></td>

							<td><a href="#modal<?php echo $dados['idCliente']; ?>" class="btn-floating red modal-trigger"><i class="material-icons">delete</i></a></td>
